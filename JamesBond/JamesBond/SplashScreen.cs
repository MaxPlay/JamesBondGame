...
namespace JamesBond
{
    public class SplashScreen : State
    {
        ...
        public SplashScreen(string name, StateMachine statemachine)
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (player.State == MediaState.Playing)
                spriteBatch.Draw(player.GetTexture(), window, Color.White * fadeout);

            spriteBatch.Draw(logo, new Vector2(Game1.graphics.PreferredBackBufferWidth / 2, Game1.graphics.PreferredBackBufferHeight / 2 - 50 * (1 - fadeout)), null, Color.White * (1 - fadeout), 0, new Vector2(logo.Bounds.Center.X, logo.Bounds.Center.Y), 1, SpriteEffects.None, 0);
        ...
        {
            video = Game1.ContentManager.Load<Video>("GunBarrel");
